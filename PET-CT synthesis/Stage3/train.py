...
if __name__ == '__main__':
    ...
    ckpt = torch.load('./Pretrained_model/PETsin_CTsin_500.pth',map_location=device)
    ...
    ckpt = torch.load('./Pretrained_model/CTsin_PETsin_350.pth',map_location=device)
    ...
    ckpt = torch.load('./Pretrained_model/PETimg_CTimg_100.pth',map_location=device)
    ...
    ckpt = torch.load('./Pretrained_model/CTimg_PETimg_100.pth',map_location=device)
